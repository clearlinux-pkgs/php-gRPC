...
Source0  : https://pecl.php.net/get/grpc-1.62.0.tgz
...
%prep
%setup -q -n grpc-1.62.0
cd %{_builddir}/grpc-1.62.0
pushd ..
cp -a grpc-1.62.0 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20230831/grpc.so
